...
_G.ConfigFolder = _G.ConfigFolder or "noxius/Config/"

-- Noxius asset ID (langsung ada di lib, gak usah tambahin lagi di script lain)
noxius_logo = "104845791898751"           -- logo title bar & notif
noxius_toggle_ui_icon = "125641780017639" -- icon tombol toggle UI
...
local Icons = {
    lexshub1   = "rbxassetid://104845791898751",
...
function Noxius:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(160, 80, 220)
...
function NoxiusNotify(msg, delay, color, title, desc)
    return Noxius:MakeNotify({
        ...
        Color = color or Color3.fromRGB(160, 80, 220),
        Delay = delay or 4
    })
end
